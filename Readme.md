...
Hastlayer uses [FPGAs](https://en.wikipedia.org/wiki/Field-programmable_gate_array) (chips that can be "re-wired" on the fly): The user simply selects the compute-bound part of his .NET program and Hastlayer seamlessly swaps it out with a generated FPGA implementation. Since Hastlayer transforms .NET Intermediate Language assemblies (but not C#, VisualBasic or other code), the user can use any .NET language (e.g. C#, VB, F#, C++, Python, PHP, and JavaScript).

Hastlayer was also featured on [.NET Conf 2017](https://channel9.msdn.com/events/dotnetConf/2017/T212); the [recorded session](https://channel9.msdn.com/events/dotnetConf/2017/T212) covers Hastlayer's interesting features. You can view the session on [YouTube](https://www.youtube.com/watch?v=03Sq5m3eUSs). Check out the [FAQ](https://hastlayer.com/faq) for more info.
...
(Note that due to a repository purge, the repo history doesn't contain anything from before July 2017 although development has been ongoing more or less actively from 2015.)
